              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <v-list-item
                      :disabled="item.financial_infos.amount_requested < 500000 || item.analysis.portfolio_owner.agent !== agent.id"
      ...
      <v-card>
        ...
        <v-card-text>
          <v-select
            ...
            class="ma-0 pa-0"
            :items="agents.filter(item => item.board.tag === 'di')"
            item-text="fullName"
            item-value="id"
            dense
            label="Analyste"
...
<script>
  ...
  export default {
    ...
    async beforeCreate () {
      ...
      await this.$store.dispatch('analysis/fetchAnalysisByPortfolioOwner', { sectorOwner: this.agent.id, page: this.page, item: this.perPage })
    },
    /*
    async created () {
