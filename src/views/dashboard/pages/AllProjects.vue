              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <v-list-item
                      :disabled="item.financial_infos.amount_requested < 500000 || !['directionOwner', 'divisionOwner', 'programOwner'].includes(agent.role) || agent.board.tag !== 'dex'"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async setPage (data) {
        // window.console.log({ search_data: data })
