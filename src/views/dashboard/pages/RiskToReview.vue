      ...
      <v-simple-table>
        ...
        <tbody>
          ...
          >
            ...
            <td>
              <v-menu
                v-if="agents && item.analysis && item.analysis.risk_owner.agent"
                bottom
                min-width="250px"
                rounded
                offset-y
...
<script>
  ...
  export default {
    ...
    async beforeCreate () {
      ...
      await this.$store.dispatch('analysis/fetchAnalysisByRiskOwner', { riskOwner: this.agent.id, page: this.page, item: this.perPage })
    },
    methods: {
