    ...
    <v-list-item two-line>
      <v-list-item-content>
        <v-list-item-title class="text-uppercase font-weight-regular text-h3">
          ...
          <span class="logo-normal">{{ $t('der') }}</span>
        </v-list-item-title>
      </v-list-item-content>
    </v-list-item>
      ...
      items: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              title: 'Projets Assigné',
              to: 'assigned-projects',
            },
            {
              title: 'Projets A Analyser',
